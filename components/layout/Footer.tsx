    ...
    <footer className="border-t border-[--clr-border] mt-16">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-[--clr-text-muted] leading-relaxed mb-4">
              Free, instant CPU &amp; GPU bottleneck analysis tool. Calculate hardware compatibility,
              optimize your custom PC builds, and eliminate performance scaling issues. No signup required.
            </p>
        ...
        <div className="border-t border-[--clr-border] pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <p className="text-xs text-[--clr-text-muted] text-center sm:text-right">
            Results are estimates. Not purchase advice.
